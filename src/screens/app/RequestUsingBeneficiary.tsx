...
import {
  requestUsingBeneficiaryFrm2Types,
  requestUsingBeneficiaryFrm4Types,
} from "@src/form/schema/types";
import {
  requestUsingBeneficiaryFrm2Validation,
  requestUsingBeneficiaryFrm4Validation,
...
import {
  ...
  Step4,
  Step5,
} from "@src/components/app/request-money/request-beneficiary";

export const RequestUsingBeneficiary = ({
  navigation,
}: RootStackScreenProps<appScreenNames.REQUEST_USING_BENEFICIARY>) => {
  ...
  } = useForm<requestUsingBeneficiaryFrm2Types>({
    mode: "onChange",
    resolver: yupResolver(requestUsingBeneficiaryFrm2Validation),
  });
  ...
  } = useForm<requestUsingBeneficiaryFrm4Types>({
    mode: "onChange",
    resolver: yupResolver(requestUsingBeneficiaryFrm4Validation),
  });
