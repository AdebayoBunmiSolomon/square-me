...
import {
  requestUsingContactListFrm1Types,
  requestUsingContactListFrm3Types,
} from "@src/form/schema/types";
import {
  requestUsingContactListFrm1Validation,
  requestUsingContactListFrm3Validation,
...
import {
  ...
  Step3,
  Step4,
} from "@src/components/app/request-money/request-contact-list";

export const RequestUsingContactList = ({
  navigation,
}: RootStackScreenProps<appScreenNames.REQUEST_USING_CONTACT_LIST>) => {
  ...
  } = useForm<requestUsingContactListFrm1Types>({
    mode: "onChange",
    resolver: yupResolver(requestUsingContactListFrm1Validation),
  });
  ...
  } = useForm<requestUsingContactListFrm3Types>({
    mode: "onChange",
    resolver: yupResolver(requestUsingContactListFrm3Validation),
  });
