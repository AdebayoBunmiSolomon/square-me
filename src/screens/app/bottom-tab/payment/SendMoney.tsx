...
import { sendMoneyOptions } from "@src/constants/send-money";
...
export const SendMoney = ({
  ...
  return (
    <>
      ...
      <BottomSheet
        title='Where do you want to send money?'
        modalRef={modalRef}
        ...
        <View
          ...
          {sendMoneyOptions &&
            sendMoneyOptions.map((item, index) => (
              <TouchableOpacity
                ...
                onPress={() => {
                  if (index === 0) {
                    ...
                    navigation.navigate(appScreenNames.SEND_TO_CONTACT_LIST);
                  }
                }}>
